    ...
    <table>
        ...
        <tbody> 
            ...
            <tr>
                ...
                <td>{{ $sub->plan->name ?? 'N/A' }}</td> {{-- Fixed: changed subscriptionPlan to plan --}}
                <td>{{ $sub->end_date ? \Carbon\Carbon::parse($sub->end_date)->format('F d, Y') : 'N/A' }}</td>
            </tr>
            @empty
            @endforelse
        ...
        <tbody>
            ...
            @forelse ($activeSubscriptions as $i => $active)
                <tr>
                    ...
                    <td>{{ $active->end_date ? \Carbon\Carbon::parse($active->end_date)->format('F d, Y') : 'N/A' }}</td>
                </tr>
            @empty
            @endforelse 
