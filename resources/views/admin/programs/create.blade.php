...
@section('content')
    ...
    <div style="margin-bottom: 2rem;">
        <a href="{{ route('admin.programs.index') }}" class="btn btn-outline" style="border-color: #fff; color: #fff; margin-top: 10px;">
    ...
    <div class="form-card">
        ...
        <form action="{{ route('admin.programs.store') }}" method="POST">
            ...
            <div style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                ...
                <a href="{{ route('admin.programs.index') }}" class="btn btn-outline" style="border-color: #fff; color: #fff">
