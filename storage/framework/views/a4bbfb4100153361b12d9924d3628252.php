<?php $__env->startSection('title', 'Edit Workout - FitClub'); ?>
...
<div class="workout-form-container">
    ...
    <div class="workout-form-card">
        ...
        <form action="<?php echo e(route('workout-logs.update', $workoutLog->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input type="date" 
                               ...
                               id="workout_date" 
                               name="workout_date" 
                               value="<?php echo e(old('workout_date', $workoutLog->workout_date->format('Y-m-d'))); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="exercise_id" name="exercise_id">
                            ...
                            <?php $__currentLoopData = $exercises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exercise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($exercise->id); ?>" <?php echo e(old('exercise_id', $workoutLog->exercise_id) == $exercise->id ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="training_program_id" name="training_program_id">
                            ...
                            <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($program->id); ?>" <?php echo e(old('training_program_id', $workoutLog->training_program_id) == $program->id ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="number" 
                                   ...
                                   id="sets" 
                                   name="sets" 
                                   value="<?php echo e(old('sets', $workoutLog->sets)); ?>"
                                   min="1"
                                   placeholder="e.g., 3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="number" 
                                   ...
                                   id="reps" 
                                   name="reps" 
                                   value="<?php echo e(old('reps', $workoutLog->reps)); ?>"
                                   min="1"
                                   placeholder="e.g., 10">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="number" 
                                   ...
                                   id="weight" 
                                   name="weight" 
                                   value="<?php echo e(old('weight', $workoutLog->weight)); ?>"
                                   min="0"
                                   step="0.5"
                                   placeholder="e.g., 50">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               value="<?php echo e(old('duration_minutes', $workoutLog->duration_minutes)); ?>"
                               min="1"
                               placeholder="e.g., 45">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               id="distance" 
                               name="distance" 
                               value="<?php echo e(old('distance', $workoutLog->distance)); ?>"
                               min="0"
                               step="0.1"
                               placeholder="e.g., 5.0">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               value="<?php echo e(old('calories_burned', $workoutLog->calories_burned)); ?>"
                               min="0"
                               placeholder="e.g., 300">
                    </div>
                </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <div class="difficulty-selector-alt">
                        ...
                        <div class="difficulty-slider-container">
                            <input type="range" 
                                   ...
                                   min="1" 
                                   max="3" 
                                   value="<?php echo e(old('difficulty', $workoutLog->difficulty) == 'easy' ? '1' : (old('difficulty', $workoutLog->difficulty) == 'medium' ? '2' : (old('difficulty', $workoutLog->difficulty) == 'hard' ? '3' : '0'))); ?>"
                                   step="1">
                        </div>
                        
                        <div class="difficulty-progress">
                            <div class="difficulty-progress-bar <?php echo e(old('difficulty', $workoutLog->difficulty) ?? 'easy'); ?>" id="difficulty-progress-bar"></div>
                        </div>
                        
                        <div class="difficulty-levels">
                            <div class="difficulty-level easy <?php echo e(old('difficulty', $workoutLog->difficulty) == 'easy' ? 'active' : ''); ?>" data-level="easy">
                                <span class="difficulty-icon">😊</span>
                                <div class="difficulty-label">Easy</div>
                                <div class="difficulty-description">Light workout</div>
                            </div>
                            <div class="difficulty-level medium <?php echo e(old('difficulty', $workoutLog->difficulty) == 'medium' ? 'active' : ''); ?>" data-level="medium">
                                <span class="difficulty-icon">😅</span>
                                <div class="difficulty-label">Medium</div>
                                <div class="difficulty-description">Moderate intensity</div>
                            </div>
                            <div class="difficulty-level hard <?php echo e(old('difficulty', $workoutLog->difficulty) == 'hard' ? 'active' : ''); ?>" data-level="hard">
                                <span class="difficulty-icon">😰</span>
                    ...
                    <div style="display: none;">
                        <input type="radio" name="difficulty" value="easy" <?php echo e(old('difficulty', $workoutLog->difficulty) == 'easy' ? 'checked' : ''); ?> id="difficulty-easy">
                        <input type="radio" name="difficulty" value="medium" <?php echo e(old('difficulty', $workoutLog->difficulty) == 'medium' ? 'checked' : ''); ?> id="difficulty-medium">
                        <input type="radio" name="difficulty" value="hard" <?php echo e(old('difficulty', $workoutLog->difficulty) == 'hard' ? 'checked' : ''); ?> id="difficulty-hard">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="rating-input">
                        <input type="hidden" name="rating" id="rating" value="<?php echo e(old('rating', $workoutLog->rating ?? 0)); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <textarea class="form-control" 
                                  ...
                                  name="notes" 
                                  rows="4" 
                                  placeholder="How did you feel? Any observations or improvements?"><?php echo e(old('notes', $workoutLog->notes)); ?></textarea>
...
<script>
    ...
    function confirmDelete() {
        if (confirm('Are you sure you want to delete this workout? This action cannot be undone.')) {
            ...
            form.method = 'POST';
            form.action = '<?php echo e(route('workout-logs.destroy', $workoutLog->id)); ?>';
    ...
    updateStars(<?php echo e($workoutLog->rating ?? 0); ?>);
...
<?php echo $__env->make('skeleton.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\backup\MASUDOG-NOSENAS_proj\resources\views\workout-logs\edit.blade.php ENDPATH**/ ?>