...
<body>
    ...
    <h2>Generated on: <?php echo e(now()->format('F d, Y h:i A')); ?></h2>

    <div class="total">Total Revenue: ₱<?php echo e(number_format($revenue, 2)); ?></div>
        ...
        <tbody>
            ...
            <?php if($membersCount > 0): ?>
                ...
                <tr>
                    ...
                    <td><?php echo e($row['user']->email ?? 'N/A'); ?></td>
...
</html><?php /**PATH C:\xampp\htdocs\backup\MASUDOG-NOSENAS_proj\resources\views/admin/reports/payments_pdf.blade.php ENDPATH**/ ?>