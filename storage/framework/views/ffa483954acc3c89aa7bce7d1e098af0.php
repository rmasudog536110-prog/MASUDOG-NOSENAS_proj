                ...
                <div class="section-card">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" 
                                  ...
                                  name="instructions" 
                                  rows="6" 
                                  placeholder="Enter each instruction step on a new line"><?php echo e(old('instructions', $exercise->instructions)); ?></textarea>
                        <div class="form-help">
                            <i class="fa-solid fa-info-circle"></i>
...
<?php echo $__env->make('skeleton.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\backup\MASUDOG-NOSENAS_proj\resources\views\admin\exercises\edit.blade.php ENDPATH**/ ?>