    ...
    <div class="card shadow-sm" style="max-width: 700px; margin: 0 auto; background-color: var(--card); color: var(--foreground); border-radius: var(--radius);">
        <div class="card-body">
            ...
            <div class="mb-4">
                ...
                <p><strong>Price:</strong> ₱<?php echo e(number_format($subscription->plan->price, 2)); ?></p>
                <p><strong>Description:</strong> <?php echo e($subscription->plan->description); ?></p>
            </div>

            
            <form method="POST" action="<?php echo e(route('payment.process', $subscription->id)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-3">
                    ...
                    <input 
                        type="text" 
                        class="form-control" 
                        value="₱<?php echo e(number_format($subscription->plan->price, 2)); ?>" 
                        readonly
                    >
                </div>
            ...
            <div class="text-center mt-4">
                <a href="<?php echo e(route('index')); ?>" class="text-decoration-none" style="color: var(--primary);">Cancel and return to dashboard</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('skeleton.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\backup\MASUDOG-NOSENAS_proj\resources\views\payment\payment.blade.php ENDPATH**/ ?>