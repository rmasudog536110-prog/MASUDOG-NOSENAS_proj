<?php $__env->startSection('title', 'Manage Programs - Admin'); ?>
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-box">
                ...
                <div class="value"><?php echo e($stats['active']); ?></div>
            </div>
            <div class="stat-box">
                <h3>Inactive Programs</h3>
                <div class="value"><?php echo e($stats['inactive']); ?></div>
            </div>
        </div>
        ...
        <div class="programs-grid">
            <?php $__empty_1 = true; $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="program-card">
                    <div class="program-header">
                        <div>
                            <h3 class="program-title"><?php echo e($program->title); ?></h3>
                            <span class="program-level level-<?php echo e($program->level); ?>">
                                <?php echo e(ucfirst($program->level)); ?>

                            </span>
                        </div>
                        <span class="status-badge status-<?php echo e($program->is_active ? 'active' : 'inactive'); ?>">
                    ...
                    <div class="program-details">
                        <div>
                            ...
                            <strong>Duration:</strong> <?php echo e($program->duration_weeks); ?> weeks
                        </div>
                        <div>
                            <i class="fa-solid fa-dumbbell"></i>
                            <strong>Workouts:</strong> <?php echo e($program->workout_counts); ?> per week
                        </div>
                        <?php if($program->equipment_required): ?>
                            <div>
                                <i class="fa-solid fa-tools"></i>
                                <strong>Equipment:</strong> <?php echo e($program->equipment_required); ?>
                    ...
                    <div class="program-actions">
                        ...
                        <form action="<?php echo e(route('admin.programs.toggle', $program)); ?>" 
                              method="POST" 
                              style="display: inline;">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="btn btn-outline btn-sm">
                                <i class="fa-solid fa-<?php echo e($program->is_active ? 'ban' : 'check'); ?>"></i>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div style="grid-column: 1 / -1; text-align: center; padding: 3rem; color: var(--muted-foreground);">
                    ...
                    <a href="<?php echo e(route('admin.programs.create')); ?>" class="btn btn-primary" style="margin-top: 1rem;">
                        <i class="fa-solid fa-plus"></i> Add New Program
                    </a>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('skeleton.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\backup\MASUDOG-NOSENAS_proj\resources\views\admin\programs\index.blade.php ENDPATH**/ ?>