        ...
        <div class="footer-bottom">
            <div class="footer-bottom-content">
                ...
                <div class="payment-methods">
                    <span>We Accept:</span>
                        <img src="<?php echo e(asset('imgs/gcash-logo.jpg')); ?>" alt="GCash" class="payment-logo">
                        <img src="<?php echo e(asset('imgs/paymaya-logo.png')); ?>" alt="PayMaya" class="payment-logo">
                        <img src="<?php echo e(asset('imgs/mastercard-logo.jpg')); ?>" alt="Mastercard" class="payment-logo">
...
<?php /**PATH C:\Repo\MASUDOG-NOSENAS_proj\resources\views/index/footer.blade.php ENDPATH**/ ?>